...
2.4 No killing sprees, where you chase and kill more than 5 players within an hour. This rule only applies to the overworld.
...
3.1 No spamming, like repeatedly advertising trades or flooding the chat.

3.2 No cursing or bypassing the chat filter. Keep it appropriate for everyone.

3.3 No harmful, abusive, or inappropriate expressions in chat, signs, skins, or buildings. This includes name-calling, insulting, bullying, harrashment, hate speech, discrimination, obscene content, talking or threatening about self-harm, encouraging violence or hatred towards others.

3.4 No references to Nazi Germany, the Soviet Union, and the Islamic State, like Swastikas, Soviet Sickles.

3.5 No sharing others' personal information, like IP, name, email, phone number.

3.6 No misleading and baiting a player to type a command, like /suicide.

3.7 Do not accuse rule-breakers publicly, report with /report or make a ticket at herobrine.org.

3.8 Do not discuss, disagree or appeal a staff action publicly, make a ticket a herobrine.org. You may only appeal bans and not warns or mutes.
...
4.2 No building outside of claims, except minor building outside of your own town or when settling a new town where the settlers have 7 days to claim the land. Make a ticket at herobrine.org if you want an unlawful building in unclaimed land to be removed.
...
4.7 No building on the water with exceptions like Venice, canals, and minor builds in bays and rivers. Make a ticket at herobrine.org to request permission to build on water.
...
6.1 Intentionally crashing the server or producing lag will result in a permanent ban.

6.2 Advertising other servers or products is not allowed.

6.3 Real world traders for services and items will be permanently banned.
