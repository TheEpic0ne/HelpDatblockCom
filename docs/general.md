...
Vote daily at server lists for rewards! Visit the links below and enter your Minecraft username to vote. Remember to be online on the server where you want to receive the rewards when voting.
...
- [Minecraft-server-list.com](https://minecraft-server-list.com/server/453566/vote/)
...
- [Datearth Fandom](https://datearth.fandom.com/wiki/Datearth_Wiki)
