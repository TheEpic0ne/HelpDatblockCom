...
The town under siege has a score shown in `/t` that will deterimne the siege winner. The attacker requires a positive score to win and the defender requires negative score to win when siege duration ends. Siege duration is 3 days unless a side surrender early. 
